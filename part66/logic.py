...
MODULES = {
    ...
    "M11A": {"titre": "Aérodynamique, structures et systèmes — avion à turbine",
              "disponible": False},
    "M15": {"titre": "Turbomachines à gaz", "disponible": False,  # lot 1/3 (M15.1-M15.5) validé le 2026-09-11 ; reste lot 2 (M15.6-M15.10) et lot 3 (M15.11-M15.14) avant disponible: True
